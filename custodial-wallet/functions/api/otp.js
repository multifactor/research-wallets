...
export async function onRequest({ request, env }) {
  ...
  if (searchParams.get("request")) {
    ...
    if (user !== null && !searchParams.get("res")) {
  ...
  let send_request = new Request("https://api.mailchannels.net/tx/v1/send", {
    ...
    body: JSON.stringify({
      ...
      from: { email: "otp@ciao.mfkdf.com", name: "Wallet A" },
      subject: "Your One-Time Login Code for Wallet A",
