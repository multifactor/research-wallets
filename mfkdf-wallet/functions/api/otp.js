...
export async function onRequest({ request, env }) {
  ...
  let send_request = new Request("https://api.mailchannels.net/tx/v1/send", {
    ...
    body: JSON.stringify({
      ...
      from: { email: "otp@ciao.mfkdf.com", name: "Wallet C" },
      subject: "Your One-Time Login Code for Wallet C",
